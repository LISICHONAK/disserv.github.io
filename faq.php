		...
		<div class="page-in-container">
			...
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 That's awesome, contributions are welcome! Check the <a href="">Coding Style Guidelines</a>, and <a href="/rpcs3/wiki/developer-information">Developer Information</a>. Find something you want to implement or improve (such as broken games, bugs, missing features, Roadmap goals, etc.), work on it, test your changes and send a Pull Request. If you have any questions, hit us up on our <a href="https://discord.gg/TwXTjhpUs9">Discord Server</a> in the #development channel.
						</p>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 Good, you can do it through the <a href="">GitHub Issue Tracker</a> (development-related issues) or the Forums (general questions, support and commercial/homebrew games discussion). Please be sure to follow these guidelines and the ones on the issue template before sending anything:
						</p>
						<br>
						<p>
