			...
			<div class='button-con-container'>
				...
				<div class="label-con-wrapper label-right darkmode-panel">
					...
					<div class="label-tx1-text darkmode-txt">
						<span>
						For detailed changes, see <a href="" target="_blank">commits</a> via GitHub. </span>
					</div>
				</div>
			</div>
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p class="download-desc">
							...
							<br>
							<br>
							<b>Download AppImage using CLI </b><span class="highlight darkmode-highlight">wget --content-disposition </span> or <span class="highlight darkmode-highlight">curl -JLO </span>
							<br>
							<b>Compile on arch using AUR </b><span class="highlight darkmode-highlight">git clone /rpcs3-git.git && cd rpcs3-git && makepkg -sri</span>
						</p>
					</div>
					</div>
					</div>
		...
		<div class="page-in-container">
			<div class='container-con-block darkmode-block'>
				<div class='container-con-wrapper'>
					...
					<div class='container-tx2-block darkmode-txt'>
						<p>
							 Downloading the website source allows you to clone, fork or contribute any enhancements via GitHub. RPCS3.net is licensed under the GNU General Public License v2.0. Its core developed and maintained by <a href='' target="_blank">DAGINATSUKO</a>, while the compatibility database is developed and maintained by <a href='' target="_blank">Ani</a>.
						</p>
					</div>
				</div>
			</div>
